...
**Status**: Mature draft with substantial data (exp side strong; ln d=5 boundary results included as first-class case). 20-seed controls and ln:5 longer-reanneal tuning are in progress for final precision.
