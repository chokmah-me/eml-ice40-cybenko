// Streaming testbench for mlp_ln_h8_d2_stream: byte-feeds the 256-point sweep,
// reassembles output bytes, prints x_raw,y_raw CSV (same format as other tbs).
`timescale 1ns/1ps
module mlp_ln_h8_d2_stream_tb;
    ...
    wire [7:0] out_data;
    wire out_valid;
    mlp_ln_h8_d2_stream dut (.clk(clk), .in_data(in_data), .in_valid(in_valid),
