// Streaming testbench for ln_d4_pipe_stream: byte-feeds the 256-point sweep,
// reassembles output bytes, prints x_raw,y_raw CSV (same format as other tbs).
`timescale 1ns/1ps
module ln_d4_pipe_stream_tb;
    ...
    wire [7:0] out_data;
    wire out_valid;
    ln_d4_pipe_stream dut (.clk(clk), .in_data(in_data), .in_valid(in_valid),
